...
export default function About() {
    return(
        <div className="p-5 text-center w-75 m-auto">
            ...
            <a href="https://www.instagram.com/WildFlyBrewing/" target="_blank" rel="noopener noreferrer" className="btn btn-primary">Follow @wildflybrewing <i className="fa-brands fa-instagram p-1"></i> </a>
        </div>
    )
};